...
const IpAdress = 'shelly-86-eu.shelly.cloud' ; // adresse ip de la prise plug s

// recuperer les infos de la prise plug s
function getPlugS() {
    fetch('https://shelly-86-eu.shelly.cloud/device/status?id=80646F827174&auth_key=MWRmYzM2dWlkE62C6C4C76F817CE0A3D2902F5B5D4C115E49B28CF8539114D9246505DE5D368D560D06020A92480')
        .then((response) => {
